...
export const headerClass = style({
  ...
  '@media': {
    [themeVars.media.minWidth.sm]: {
      marginBlockStart: '-1.3125rem',
      paddingBlock: '1.3125rem 1.5rem',
    },
...
const headingClass = style({
  ...
  '@media': {
    [themeVars.media.minWidth.sm]: { marginBottom: '0.375rem' },
    [themeVars.media.minWidth.lg]: { marginBottom: '0.5rem' },
  },
});
